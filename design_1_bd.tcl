...
proc create_root_design { parentCell } {
  ...
  set nSync_0 [ create_bd_port -dir O nSync_0 ]

  # Create instance: ADC_controller_0, and set properties
  set ADC_controller_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ADC_controller:1.0 ADC_controller_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins DAC_controller_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ADC_controller_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net ADC_controller_0_CS [get_bd_ports CS_0] [get_bd_pins ADC_controller_0/CS]
  connect_bd_net -net ADC_controller_0_SCLK [get_bd_ports SCLK_0] [get_bd_pins ADC_controller_0/SCLK]
  connect_bd_net -net DAC_controller_0_D1 [get_bd_ports D1_0] [get_bd_pins DAC_controller_0/D1]
  connect_bd_net -net DAC_controller_0_clk_out [get_bd_ports clk_out_0] [get_bd_pins DAC_controller_0/clk_out]
  connect_bd_net -net DAC_controller_0_nSync [get_bd_ports nSync_0] [get_bd_pins DAC_controller_0/nSync]
  connect_bd_net -net MISO_0_1 [get_bd_ports MISO_0] [get_bd_pins ADC_controller_0/MISO]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ADC_controller_0/s00_axi_aclk] [get_bd_pins DAC_controller_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins ADC_controller_0/clk_100] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins ADC_controller_0/s00_axi_aresetn] [get_bd_pins DAC_controller_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ADC_controller_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs DAC_controller_0/S00_AXI/S00_AXI_reg] -force
